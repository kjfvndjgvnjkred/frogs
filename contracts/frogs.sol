...
contract Frogs is ERC721, Ownable {
    using Strings for uint256;
    ...
    ERC721("Frogs", "FROGS")
    {
        _base = "https://avaxfrogs.org/api/";
        _description = "Frogs are the ERC-404 version of NodeFrogs";
    }
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        string memory image = Strings.toString(id);
        string memory baseURI = _baseURI();
        string memory name = string.concat(name(), " #", Strings.toString(id));
        string memory description = _description;
        string memory json = string.concat('{"name": "', name, '","description":"', description, '","image":"', baseURI, "image/", image, '"}');
